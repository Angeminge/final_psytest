...
export declare type MessageType = 'MESSAGE_TO_SKILL' | 'SERVER_ACTION' | 'RUN_APP' | 'CLOSE_APP'|'CALL_RATING';
...
export declare type Payload = MESSAGE_TO_SKILL | SERVER_ACTION | RUN_APP | CLOSE_APP | CALL_RATING;
